...
addon = xbmcaddon.Addon('plugin.video.REROCAVERNA')
...
SOURCES = [{"url": "https://dl.dropbox.com/s/uo5c7lcrnzcmgng/PRINCIPALRETROADDONS.xml.xml?", "fanart": "https://dl.dropbox.com/s/v9p34nw3rtez5a0/RETROCAVERNA%20LOGO.jpg?"}]



def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.RETROCAVERNA-%s]: %s" %(addon_version, string))
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(RETROCAVERNA,New source added.,5000,"+icon+")")
        if not url is None:
